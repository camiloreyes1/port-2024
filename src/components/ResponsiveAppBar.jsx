...
const navItems = ['Home', 'About Me', 'Projects', 'Experience'];
...
function DrawerAppBar(props) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar component="nav" sx={{ backgroundColor: (theme) => theme.palette.warning.main }}>
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
            {navItems.map((item) => (
              <Button key={item} sx={{ color: '#fff', fontFamily: 'Protest Strike' }}>
                {item}
              </Button>
            ))}
          </Box>
